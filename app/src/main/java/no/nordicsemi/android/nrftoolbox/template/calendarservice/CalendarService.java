package no.nordicsemi.android.nrftoolbox.template.calendarservice;
    ...
    public static HashMap<String, List<CalendarEvent>> readCalendar(Context context, int days, int hours) {
        ...
        for (String id : calendarIds) {
            ...
            Cursor eventCursor = contentResolver.query(builder.build(),
                    new String[]  { CalendarContract.Events.TITLE, CalendarContract.Events.DTSTART, CalendarContract.Events.DTEND, CalendarContract.Events.ALL_DAY}, CalendarContract.Events.CALENDAR_ID + "=" + id,
